...
TODO: will add soon the powerful replacer script after removing company specific data, which I am using to create component, types,reducers ,actions,middleware and basic tests also, saving **150+ lines** of manual typing, which was the main motivation behind this vscode extension.
